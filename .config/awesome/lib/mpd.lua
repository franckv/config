...
-- (see <a href="http://github.com/otkrove/ion3-config/tree/master/mpd.lua" class="external free" title="http://github.com/otkrove/ion3-config/tree/master/mpd.lua" rel="nofollow">http://github.com/otkrove/ion3-config/tree/master/mpd.lua</a>)
require("socket")
